...
// From Nathan Gordon https://medium.com/@gordonnl/fire-and-haze-b4561743b17
...
const fire = (window, root) => {
  ...
  function initWorld() {
    ...
    root.mount.appendChild(_renderer.domElement)
  ...
  function initBackground() {
    ...
    textureLoader.load('https://cinemont.com/tutorials/zelda/rock.jpg', t => {
